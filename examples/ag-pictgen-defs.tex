...
\newcommand{\agpictureScaledAtY}[4]{ \begingroup\renewcommand{\agcoordpary}{#1}\renewcommand{\agcoordlocy}{#2}\begin{tikzpicture}[scale=#3, transform shape]\input{#4.tikz}\end{tikzpicture}\endgroup }
\newcommand{\agpictureScaled}[2]{ \agpictureScaledAtY{5}{3}{#1}{#2} }
\newcommand{\agpictureAtY}[3]{ \agpictureScaledAtY{#1}{#2}{1}{#3} }
\newcommand{\agpicture}[1]{ \agpictureScaled{1}{#1} }
